...
if __name__ == "__main__":
    ...
    image_size = [1,128,128] # input img: 64 x 64 for CelebA
    test_y = torch.LongTensor([[0,0], [0,0], [1,1], [1,1]])

    retea_G = Generator(dim_zgomot = 100, img_size=128, attribute_number=2)
    result = retea_G(vector_generare, test_y)
    ic(result.shape)  # trebuie sa fie 3 x 128 x 128
